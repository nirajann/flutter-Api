...
final _entities = <ModelEntity>[
  ModelEntity(
      ...
      name: 'Course',
      lastPropertyId: const IdUid(3, 3001493179036046454),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            ...
            type: 9,
            flags: 2080,
            indexId: const IdUid(4, 3231238904609251626)),
        ModelProperty(
            ...
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3001493179036046454),
            name: 'id',
            type: 6,
            flags: 129)
      ],
  ...
  ModelEntity(
      ...
      backlinks: <ModelBacklink>[]),
  ModelEntity(
      id: const IdUid(4, 3740944185927238633),
      name: 'Batch',
      lastPropertyId: const IdUid(3, 583091230346431222),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6106124293397752658),
            name: 'id',
            type: 6,
            flags: 129),
        ModelProperty(
            id: const IdUid(2, 5852480900117531466),
            name: 'batchId',
            type: 9,
            flags: 2080,
            indexId: const IdUid(3, 8663826259327256982)),
        ModelProperty(
            id: const IdUid(3, 583091230346431222),
            name: 'batchName',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(4, 3740944185927238633),
      lastIndexId: const IdUid(4, 3231238904609251626),
      lastRelationId: const IdUid(1, 3909601909676186380),
      lastSequenceId: const IdUid(0, 0),
      retiredEntityUids: const [2565643257256048285],
...
class Course_ {
  ...
  static final courseId =
      QueryStringProperty<Course>(_entities[0].properties[0]);

  /// see [Course.courseName]
  static final courseName =
      QueryStringProperty<Course>(_entities[0].properties[1]);

  /// see [Course.id]
  static final id = QueryIntegerProperty<Course>(_entities[0].properties[2]);
}
...
class Batch_ {
  /// see [Batch.id]
  static final id = QueryIntegerProperty<Batch>(_entities[2].properties[0]);

  /// see [Batch.batchId]
  static final batchId = QueryStringProperty<Batch>(_entities[2].properties[1]);

  /// see [Batch.batchName]
  static final batchName =
      QueryStringProperty<Batch>(_entities[2].properties[2]);
}
